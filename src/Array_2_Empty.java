public class Array_2_Empty {
    ...
    public int[] fizzArray(int n) {
        ...
        0, 1, 2, ... n-1. The given n may be 0, in which case just return a length 0 array. You do not need a
    ...
    public String[] fizzBuzz(int start, int end) {
        ...
        first problem for job interviews. (See also: FizzBuzz Code.) Consider the series of numbers beginning at
    ...
    public int[] fizzArray3(int start, int end) {
        ...
        but not including end, so start=5 and end=10 yields {5, 6, 7, 8, 9}. The end number will be greater or
        equal to the start number. Note that a length-0 array is valid. (See also: FizzBuzz Code)
    ...
    public int[] zeroFront(int[] nums) {
        ...
        zeros are grouped at the start of the array. The order of the non-zero numbers does not matter. So {1, 0, 0, 1}
